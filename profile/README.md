...
- [**OpenRegister**](https://github.com/ConductionNL/openregister): schema-driven object store with audit trail. The data foundation underneath every other app.
- [**OpenCatalogi**](https://github.com/ConductionNL/opencatalogi): federated catalogue and public publication for any register.
- [**Integriq**](https://github.com/ConductionNL/openconnector): integration layer for REST, SOAP, GraphQL, file drops, and message queues.
- [**Filinq**](https://github.com/ConductionNL/docudesk): anonymise, sign, and publish documents straight from your registers.

Plus [LaunchPad](https://github.com/ConductionNL/launchpad), [Larpinq](https://github.com/ConductionNL/larpingapp), [Pipelinq](https://github.com/ConductionNL/pipelinq), [Dossiq](https://github.com/ConductionNL/procest), [Decidiq](https://github.com/ConductionNL/decidesk), [Deskdesk](https://github.com/ConductionNL/deskdesk), [Learniq](https://github.com/ConductionNL/scholiq), [Shillinq](https://github.com/ConductionNL/shillinq), [ZaakAfhandelApp](https://github.com/ConductionNL/zaakafhandelapp), [Buildiq](https://github.com/ConductionNL/openbuild), and [Thematiq](https://github.com/ConductionNL/nldesign).
...
Self-service is free: docs, GitHub issues, community channels. For paid implementation or support, [conduction.nl/support](https://www.conduction.nl/support) routes to a partner.
