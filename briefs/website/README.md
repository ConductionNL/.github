...
| [`references/`](./references/) | — (visuele referentie) | 6 screenshots van referentie-sites per illustratie-richting, lokaal opgeslagen zodat de brief zelf-complete is. Bevat `ref-a-honeycomb-3d-platform.png` — dé visuele referentie voor de homepage-hero (richting A2). |
