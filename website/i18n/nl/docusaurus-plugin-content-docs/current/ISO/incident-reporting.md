...
Bij een ernstig incident gelden deze regels:
...
3. **Eén persoon leidt, de rest ondersteunt** — de dev lead of een MT-lid coördineert; vermijd parallelle besluitvorming
...
7. **Escaleer vroeg** — twijfel je of het serieus is? Behandel het als serieus. Afschalen is makkelijker dan inhalen
