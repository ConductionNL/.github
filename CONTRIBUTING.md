...
Enhancement suggestions are tracked as issues on GitHub (`github.com/ConductionNL`), where all Conduction work lives. When creating an enhancement suggestion, please include:
...
These rules are enforced organization-wide across all `ConductionNL` (GitHub) repositories. They cannot be overridden at the repository level.
