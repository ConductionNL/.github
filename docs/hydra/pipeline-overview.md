...
```json
{
  ...
  "pipeline": {
    "code_review": {
      ...
      "fixes_applied": [
        {
          "file": "lib/Service/LedgerService.php",
          "line": 42,
          "rule": "PHPCS/PSR12",
          "note": "Added missing blank line after namespace"
        }
      ],
      "unfixed": []
    },
    "security_review": {
      ...
      "fixes_applied": [
        {
          "file": "lib/Db/InvoiceMapper.php",
          "line": 77,
          "rule": "CWE-89",
          "note": "Replaced string concatenation with prepared statement"
        }
      ],
      "unfixed": []
    },
