...
| [softwarecatalog](https://github.com/ConductionNL/softwarecatalog) | Application | Catalogue | 2026-08-17 | [![main](https://img.shields.io/github/actions/workflow/status/ConductionNL/softwarecatalog/code-quality.yml?branch=main&event=push&label=main)](https://github.com/ConductionNL/softwarecatalog/actions/workflows/code-quality.yml?query=branch%3Amain+event%3Apush) | [![beta](https://img.shields.io/github/actions/workflow/status/ConductionNL/softwarecatalog/code-quality.yml?branch=beta&event=push&label=beta)](https://github.com/ConductionNL/softwarecatalog/actions/workflows/code-quality.yml?query=branch%3Abeta+event%3Apush) | [![development](https://img.shields.io/github/actions/workflow/status/ConductionNL/softwarecatalog/code-quality.yml?branch=development&event=push&label=development)](https://github.com/ConductionNL/softwarecatalog/actions/workflows/code-quality.yml?query=branch%3Adevelopment+event%3Apush) |
| [hrmq](https://github.com/ConductionNL/hrmq) | Application | HR & payroll | 2026-08-12 | [![main](https://img.shields.io/github/actions/workflow/status/ConductionNL/hrmq/code-quality.yml?branch=main&event=push&label=main)](https://github.com/ConductionNL/hrmq/actions/workflows/code-quality.yml?query=branch%3Amain+event%3Apush) | [![beta](https://img.shields.io/github/actions/workflow/status/ConductionNL/hrmq/code-quality.yml?branch=beta&event=push&label=beta)](https://github.com/ConductionNL/hrmq/actions/workflows/code-quality.yml?query=branch%3Abeta+event%3Apush) | [![development](https://img.shields.io/github/actions/workflow/status/ConductionNL/hrmq/code-quality.yml?branch=development&event=push&label=development)](https://github.com/ConductionNL/hrmq/actions/workflows/code-quality.yml?query=branch%3Adevelopment+event%3Apush) |
...
| [app-versions](https://github.com/ConductionNL/app-versions) | Tooling | App lifecycle | 2026-08-12 | [![main](https://img.shields.io/github/actions/workflow/status/ConductionNL/app-versions/code-quality.yml?branch=main&event=push&label=main)](https://github.com/ConductionNL/app-versions/actions/workflows/code-quality.yml?query=branch%3Amain+event%3Apush) | [![beta](https://img.shields.io/github/actions/workflow/status/ConductionNL/app-versions/code-quality.yml?branch=beta&event=push&label=beta)](https://github.com/ConductionNL/app-versions/actions/workflows/code-quality.yml?query=branch%3Abeta+event%3Apush) | [![development](https://img.shields.io/github/actions/workflow/status/ConductionNL/app-versions/code-quality.yml?branch=development&event=push&label=development)](https://github.com/ConductionNL/app-versions/actions/workflows/code-quality.yml?query=branch%3Adevelopment+event%3Apush) |
...
| --- | --- | --- | --- |
| Week of 17 Aug | 2026-08-21 | 2026-08-24 | openregister, doriath, nextcloud-vue |
| Week of 24 Aug | 2026-08-28 | 2026-08-31 | hermiq, openbuild (Buildiq) |
