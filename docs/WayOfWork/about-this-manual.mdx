...
This employee handbook is a [Docusaurus](https://docusaurus.io/) site hosted on GitHub Pages. The source lives in the [Conduction/.github](https://codeberg.org/Conduction/.github) repository under `website/`.
...
The landing page ([How We Work](way-of-work.md)) gives a complete overview. Deeper pages expand on each topic.
