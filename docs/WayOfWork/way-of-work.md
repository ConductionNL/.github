...
sidebar_position: 1
description: How Conduction puts its identity into practice. Being open about how we work, how we manage what we do, and how we measure ourselves.
---

# How We Work at Conduction

Conduction's mission, vision, and core values live on **[identity.conduction.nl](https://identity.conduction.nl/)**. One of those values is **being open**. This handbook is part of putting that into practice: a public record of how we operate, how we manage what we do, and how we measure ourselves.
...
- **Our handbook is public.** You're reading it. The source lives in [Conduction/.github](https://github.com/ConductionNL/.github/tree/main/docs).
- **Our roadmap is public.** Our [GitHub Projects board](https://github.com/orgs/ConductionNL/projects/4) shows what's next, what's in flight, and what's shipped.
...
We work in small, self-directed teams using agile methods. We prefer issues (tracked on GitHub) over lengthy emails, working software over documentation, and concrete results over process theatre.
