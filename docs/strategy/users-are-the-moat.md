...
- Architecture: [ADR-018 Features & Roadmap menu](https://github.com/ConductionNL/hydra/blob/development/openspec/architecture/adr-018-features-roadmap-menu.md) (proposed)
