...
_Laatste update: 2026-03-23_
_Nieuwe items toevoegen: maak een regel in de juiste tabel. Wanneer een item als OpenSpec change wordt opgepakt, verwijs naar de change directory en update de status._
