...
sidebar_label: ISO & Quality
sidebar_position: 1
description: Overview of Conduction's ISO 9001 and ISO 27001 certifications and quality management approach
---
...
1. **Identify** risks to quality, security, and continuity
...
For the organisational structure, roles, and team descriptions, see [Organisation](../WayOfWork/organisation).
...
Any employee can raise concerns or suggest improvements via [an issue on GitHub](https://github.com/ConductionNL/.github/issues) or directly with the Quality Manager.
