...
This policy is communicated to all employees via this documentation site and during onboarding. Employees are required to acknowledge this policy. Questions or concerns can be directed to the Quality & Safety Lead or raised via [an issue on GitHub](https://github.com/ConductionNL/.github/issues).
