...
The total tokens you can use across **all conversations combined** within a rolling time window. When you hit this, you see _"You've hit your limit - resets 3pm"_. Cheaper models allow more total tokens before hitting the cap:
